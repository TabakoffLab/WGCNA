...
###  open output file  ###
outputFile = "/Volumes/saba/Affymetrix/SNP.Masks/Exon.Array/Rat/Results/simplePGF.rn5masked.05Feb15.txt"
fout = open(outputFile, "wb")
fout.write("probeSetID\ttype\tIDnum\tprobeID\ttypeProbe\tgc_count\tprobe_length\tinterrogation_position\tprobe_sequence\n")

###  open input file  ###
fname = "/Volumes/saba/Affymetrix/SNP.Masks/Exon.Array/Rat/Results/RaEx-1_0-st-v1.r2.rn5masked.pgf"
